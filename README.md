...
- **Docker:** Wie man ein eigenes Image baut und damit einen Webserver betreibt  
- **Container:** Wie man eine saubere, isolierte Laufzeitumgebung erstellt  
- **Linux-Server (Hetzner):** Wie man einen Cloud-Server einrichtet und benutzt  
- **Deployment:** Wie man eine Website ohne manuelle Server-Konfiguration bereitstellt  
- **Netzwerke:** Port-Forwarding, SSH-Verbindung, Server-IP nutzen  
- **Datei-Transfer:** Wie man Dateien per Git oder SCP auf einen Server bringt  
- **Reproduzierbare Infrastruktur:** Jede Umgebung läuft gleich, egal wo  
- **Kleine Deployment-Pipeline:** Von lokal → Server → öffentlich erreichbar  
